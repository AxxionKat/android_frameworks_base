...
public class NavigationBarView extends LinearLayout implements BaseStatusBar.NavigationBarCallback {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        mNavigationBarForceMenu = Settings.System.getBoolean(cr, Settings.System.NAVIGATION_MENU_FORCE, false);
        mNavigationBarMenuLocation = Settings.System.getInt(cr, Settings.System.NAVIGATION_MENU, 0);
        mShowDpadKeys = Settings.System.getBoolean(cr, Settings.System.NAVIGATION_BAR_DPAD_KEYS, false);
        ...
        if (mSettingsObserver == null) {
            mSettingsObserver = new ContentObserver(new Handler()) {
                ...
                public void onChange(boolean selfChange) {
                    ...
                    mNavigationBarForceMenu = Settings.System.getBoolean(r, Settings.System.NAVIGATION_MENU_FORCE, false);
                    mNavigationBarMenuLocation = Settings.System.getInt(r, Settings.System.NAVIGATION_MENU, 0);
                    mShowDpadKeys = Settings.System.getBoolean(r, Settings.System.NAVIGATION_BAR_DPAD_KEYS, false);
                    setupNavigationButtons();
                    setMenuVisibility(mShowMenu, true /* force */);
                }
            };
            ...
            r.registerContentObserver(Settings.System.getUriFor(Settings.System.NAVIGATION_BAR_DPAD_KEYS),
                    false, mSettingsObserver);
            r.registerContentObserver(Settings.System.getUriFor(Settings.System.NAVIGATION_MENU),
                    false, mSettingsObserver);
            r.registerContentObserver(Settings.System.getUriFor(Settings.System.NAVIGATION_MENU_FORCE),
                    false, mSettingsObserver);
        }
    }
